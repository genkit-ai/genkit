...
class TestToImageGenerateParams:
    ...
    def test_config_passthrough(self) -> None:
        ...
        request = ModelRequest(
            ...
            config={'size': '1024x1024', 'quality': 'hd', 'n': 2},  # pyright: ignore[reportArgumentType]
        )
        got = _to_image_generate_params('dall-e-3', request)
    ...
    def test_strips_standard_genai_config(self) -> None:
        ...
        request = ModelRequest(
            ...
            config={'temperature': 0.5, 'top_k': 40, 'top_p': 0.9},  # pyright: ignore[reportArgumentType]
        )
        got = _to_image_generate_params('dall-e-3', request)
    ...
    def test_version_override(self) -> None:
        ...
        request = ModelRequest(
            ...
            config={'version': 'dall-e-3-custom'},  # pyright: ignore[reportArgumentType]
        )
        got = _to_image_generate_params('dall-e-3', request)
