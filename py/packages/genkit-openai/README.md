...
> **Tip:** Point the same plugin at any OpenAI-compatible multi-model gateway via `base_url` when you are not using the official OpenAI endpoint — for example [DaoXE](https://daoxe.com/) at `https://api.daoxe.com/v1` (`OpenAI(api_key=..., base_url="https://api.daoxe.com/v1")`).
