...
from genkit._core._model import ConfigT, Document, ModelRef
...
class Genkit:
    ...
    # Overload 2a: ModelRef[ConfigT] + only input_schema typed -> ExecutablePrompt[InputT, Any]
    @overload
    def define_prompt(
        self,
        name: str | None = None,
    ...
    # Overload 2b: str | None + only input_schema typed -> ExecutablePrompt[InputT, Any]
    @overload
    def define_prompt(
        self,
        name: str | None = None,
    ...
    # Overload 3a: ModelRef[ConfigT] + only output_schema typed -> ExecutablePrompt[Any, OutputT]
    @overload
    def define_prompt(
        self,
        name: str | None = None,
    ...
    # Overload 3b: str | None + only output_schema typed -> ExecutablePrompt[Any, OutputT]
    @overload
    def define_prompt(
        self,
        name: str | None = None,
    ...
    # Overload 4a: ModelRef[ConfigT] + neither typed -> ExecutablePrompt[Any, Any]
    @overload
    def define_prompt(
        self,
        name: str | None = None,
    ...
    # Overload 4b: str | None + neither typed -> ExecutablePrompt[Any, Any]
    @overload
    def define_prompt(
        self,
        name: str | None = None,
    ...
    def _initialize_registry(self, model: str | ModelRef[Any] | None, plugins: list[Plugin] | None) -> None:
        """Initialize the registry with default model and plugins."""
        if model:
            model_name = model.name if isinstance(model, ModelRef) else model
            self.registry.register_value('defaultModel', 'defaultModel', model_name)
    ...
    # Overload: ModelRef[ConfigT] + output_schema=type[T] -> ModelResponse[T]
    @overload
    async def generate(
        self,
        *,
    ...
    # Overload: ModelRef[ConfigT] + no output_schema -> ModelResponse[Any]
    @overload
    async def generate(
        self,
        *,
    ...
    # Overload: ModelRef[ConfigT] + output_schema=type[T] -> ModelStreamResponse[T]
    @overload
    def generate_stream(
        self,
        *,
    ...
    # Overload: ModelRef[ConfigT] + no output_schema -> ModelStreamResponse[Any]
    @overload
    def generate_stream(
        self,
        *,
