...
and a closed client's tools can no longer be selected by a flow. Whether the Dev UI lists a
provider's tools at all depends on core registry support, closed or not.
