...
def define_mcp_client(
    ...
    *,
    ...
    them, or ``<name>:tool/<server_name>_<tool>`` for one. Connection is lazy: the
    child process starts on the first tool listing.
    ...
    Args:
        ...
        server_name: Prefix for tool names. Defaults to the name the server
