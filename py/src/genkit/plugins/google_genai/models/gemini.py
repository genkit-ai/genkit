...
class FunctionCallingConfig(BaseModel):
    ...
    allowed_function_names: list[str] | None = Field(default=None, alias='allowedFunctionNames')
...
class FileSearchConfigSchema(BaseModel):
    ...
    model_config = ConfigDict(extra='allow', populate_by_name=True)
    file_search_store_names: list[str] | None = Field(default=None, alias='fileSearchStoreNames')
    metadata_filter: str | None = Field(default=None, alias='metadataFilter')
...
class ImageConfigSchema(BaseModel):
    ...
    model_config = ConfigDict(extra='allow', populate_by_name=True)
    aspect_ratio: ImageAspectRatio | None = Field(default=None, alias='aspectRatio')
    image_size: ImageSize | None = Field(default=None, alias='imageSize')
...
class GeminiConfigSchema(ModelConfig):
    ...
    api_key: str | None = Field(
        default=None,
        description='Overrides the plugin-configured API key, if specified.',
        alias='apiKey',
        exclude=True,
    )
    base_url: str | None = Field(
        default=None, description='Overrides the plugin-configured or default baseUrl, if specified.', alias='baseUrl'
    )
    api_version: str | None = Field(
        default=None,
        description='Overrides the plugin-configured or default apiVersion, if specified.',
        alias='apiVersion',
    )
    ...
    code_execution: bool | dict[str, Any] | None = Field(
        default=None, description='Enables the model to generate and run code.', alias='codeExecution'
    )
    ...
    ] = Field(default=None, alias='fileSearch')

    url_context: bool | dict[str, Any] | None = Field(
        default=None, description='Return grounding metadata from links included in the query', alias='urlContext'
    )
    ...
    ] = Field(default=None, alias='thinkingConfig')
...
class SpeechConfigSchema(BaseModel):
    ...
    voice_config: VoiceConfigSchema | None = Field(default=None, alias='voiceConfig')
...
class GeminiTtsConfigSchema(GeminiConfigSchema):
    ...
    speech_config: SpeechConfigSchema | None = Field(default=None, alias='speechConfig')
...
class GeminiImageConfigSchema(GeminiConfigSchema):
    ...
    ] = Field(default=None, alias='imageConfig')
