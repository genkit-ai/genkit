...
def _iter_over_async(ait: AsyncIterable[T], loop: AbstractEventLoop) -> Iterator[T]:
...
# Flask's ResponseReturnValue is the canonical set of things app.post can
# accept back from a handler; piggy-backing on it keeps our decorators
# in line with whatever shape Flask actually expects.
FlaskRouteReturn: TypeAlias = ResponseReturnValue
