...
from genkit.model import Candidate, FinishReason, ModelRef, get_basic_usage_stats, model_ref
...
# === AUTOGENERATED CONFIG DICTS AND MODEL REFS START ===
...
# === AUTOGENERATED CONFIG DICTS AND MODEL REFS END ===
