...
| `toolPrefix`       | `string`                               | `'delegate_to'` | Prefix for generated delegation tool names. Set to `''` to use bare agent names. A non-empty prefix also namespaces the background-task tools, so two `async` instances in one generate call need distinct prefixes.                                                                                                                                                                                        |
