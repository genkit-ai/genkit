...
func ModelRef(name string, config *genai.GenerateContentConfig) ai.ActionRef {
	return ai.NewActionRef(name, config)
}

// GoogleAIModelRef creates a ModelRef for a Google AI Gemini model.
//
// Deprecated: Use ModelRef with full name instead.
func GoogleAIModelRef(id string, config *genai.GenerateContentConfig) ai.ActionRef {
	return ai.NewActionRef(googleAIProvider+"/"+id, config)
}

// VertexAIModelRef creates a ModelRef for a Vertex AI Gemini model.
//
// Deprecated: Use ModelRef with full name instead.
func VertexAIModelRef(id string, config *genai.GenerateContentConfig) ai.ActionRef {
	return ai.NewActionRef(vertexAIProvider+"/"+id, config)
}
...
func ImageModelRef(name string, config *genai.GenerateImagesConfig) ai.ActionRef {
	return ai.NewActionRef(name, config)
}
...
func VideoModelRef(name string, config *genai.GenerateVideosConfig) ai.ActionRef {
	return ai.NewActionRef(name, config)
}
...
func EmbedderRef(name string, config *genai.EmbedContentConfig) ai.ActionRef {
	return ai.NewActionRef(name, config)
}
